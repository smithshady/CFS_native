...
# list(APPEND MISSION_GLOBAL_APPLIST cfe_assert cfe_testcase sample_lib sample_app) # Uncomment and rebuild to run functional tests at startup
...
# Note: processor ID and spacecraft ID affect the udp ports for ci_lab and to_lab, as well as SBN's ability to connect to peers. 

# Native linux / raspberry pi
SET(MISSION_CPUNAMES cpu1)
SET(cpu1_PROCESSORID 3)
SET(cpu1_STATIC_APPLIST cs cf fm hs lc mm sc ds hk md io_lib ci_lab to_lab sch_lab atsam_test sbn sbn_udp sbn_f_remap)
SET(cpu1_FILELIST cfe_es_startup.scr)
SET(cpu1_SYSTEM i686-linux-gnu)
SET(cpu1_STATIC_SYMLIST CS_AppMain,CS CF_AppMain,CF FM_AppMain,FM HS_AppMain,HS LC_AppMain,LC MM_AppMain,MM SC_AppMain,SC
    DS_AppMain,DS HK_AppMain,HK MD_AppMain,MD IO_LibInit,IO_LIB CI_LAB_AppMain,CI_LAB_APP TO_LAB_AppMain,TO_LAB_APP 
    SCH_LAB_AppMain,SCH_LAB_APP ATSAM_TEST_AppMain,ATSAM_TEST SBN_AppMain,SBN SBN_UDP_Ops,SBN_UDP SBN_F_Remap,SBN_F_REMAP)

# # ARM RTEMS6 ATSAMV71Q21B
# SET(MISSION_CPUNAMES arm-rtems6-atsamv)
# SET(arm-rtems6-atsamv_PROCESSORID 3)
# SET(arm-rtems6-atsamv_STATIC_APPLIST cs cf fm hs lc mm sc ds hk md io_lib ci_lab to_lab sch_lab atsam_test sbn sbn_udp sbn_f_remap)
# SET(arm-rtems6-atsamv_FILELIST cfe_es_startup.scr)
# SET(arm-rtems6-atsamv_SYSTEM arm-rtems6-atsamv)
# SET(arm-rtems6-atsamv_STATIC_SYMLIST CS_AppMain,CS CF_AppMain,CF FM_AppMain,FM HS_AppMain,HS LC_AppMain,LC MM_AppMain,MM SC_AppMain,SC DS_AppMain,DS HK_AppMain,HK MD_AppMain,MD IO_LibInit,IO_LIB CI_LAB_AppMain,CI_LAB_APP TO_LAB_AppMain,TO_LAB_APP SCH_LAB_AppMain,SCH_LAB_APP ATSAM_TEST_AppMain,ATSAM_TEST SBN_AppMain,SBN SBN_UDP_Ops,SBN_UDP SBN_F_Remap,SBN_F_REMAP)

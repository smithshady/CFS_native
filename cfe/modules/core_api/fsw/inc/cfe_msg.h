...
/*****************************************************************************/
/**
 * \brief Gets the message secondary header bool
 *
 * \par Description
 *          This routine gets the message secondary header bool.
 *
 * \param[in]  MsgPtr       A pointer to the buffer that contains the message @nonnull.
...
/*****************************************************************************/
/**
 * \brief Sets the message secondary header bool
 *
 * \par Description
 *          This routine sets the message secondary header bool. Typically only
 *          set within message initialization and not used by APPs.
 *
 * \param[in, out]  MsgPtr       A pointer to the buffer that contains the message @nonnull.

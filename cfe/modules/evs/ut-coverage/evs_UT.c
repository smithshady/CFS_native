...
void Test_Init(void)
{
    ...
    UT_InitData_EVS();
    appbitcmd.Payload.BitMask = CFE_EVS_EventType_DEBUG_BIT | CFE_EVS_EventType_INFORMATION_BIT | CFE_EVS_EventType_ERROR_BIT | CFE_EVS_EventType_CRITICAL_BIT;
...
void Test_WriteApp(void)
{
    ...
    CmdBuf.appbitcmd.Payload.BitMask =
        CFE_EVS_EventType_DEBUG_BIT | CFE_EVS_EventType_INFORMATION_BIT | CFE_EVS_EventType_ERROR_BIT | CFE_EVS_EventType_CRITICAL_BIT;
...
void Test_EventCmd(void)
{
    ...
    UT_InitData_EVS();
    bitmaskcmd.Payload.BitMask = CFE_EVS_EventType_INFORMATION_BIT | CFE_EVS_EventType_ERROR_BIT | CFE_EVS_EventType_CRITICAL_BIT;
...
void Test_Misc(void)
{
    ...
    AppDataPtr->EventTypesActiveFlag |= CFE_EVS_EventType_INFORMATION_BIT;

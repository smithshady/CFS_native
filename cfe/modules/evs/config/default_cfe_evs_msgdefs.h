...
#define CFE_EVS_EventType_DEBUG_BIT       0x0001
#define CFE_EVS_EventType_INFORMATION_BIT 0x0002
#define CFE_EVS_EventType_ERROR_BIT       0x0004
#define CFE_EVS_EventType_CRITICAL_BIT    0x0008

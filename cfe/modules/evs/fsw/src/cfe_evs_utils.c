    ...
    if (AppDataPtr->ActiveFlag == false)
    {
        ...
        switch (EventType)
        {
            case CFE_EVS_EventType_DEBUG:
                ...
                if ((AppDataPtr->EventTypesActiveFlag & CFE_EVS_EventType_DEBUG_BIT) == 0)
                {
            ...
            case CFE_EVS_EventType_INFORMATION:
                ...
                if ((AppDataPtr->EventTypesActiveFlag & CFE_EVS_EventType_INFORMATION_BIT) == 0)
                {
            ...
            case CFE_EVS_EventType_ERROR:
                ...
                if ((AppDataPtr->EventTypesActiveFlag & CFE_EVS_EventType_ERROR_BIT) == 0)
                {
            ...
            case CFE_EVS_EventType_CRITICAL:
                ...
                if ((AppDataPtr->EventTypesActiveFlag & CFE_EVS_EventType_CRITICAL_BIT) == 0)
                {
...
{
    uint8 EventTypeBits = (CFE_EVS_EventType_DEBUG_BIT | CFE_EVS_EventType_INFORMATION_BIT | CFE_EVS_EventType_ERROR_BIT | CFE_EVS_EventType_CRITICAL_BIT);

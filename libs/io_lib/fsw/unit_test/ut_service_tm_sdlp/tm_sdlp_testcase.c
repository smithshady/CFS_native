...
void Test_TM_SDLP_AddPacket_NotInit(void)
{
    ...
    CFE_MSG_Init((CFE_MSG_Message_t *) dataPacket, 0x0801, 55, true);
...
void Test_TM_SDLP_AddIdlePacket_BadMid(void)
{
    ...
    CFE_MSG_Init((CFE_MSG_Message_t *) dataPacket, 0x0901, 55, true);
...
void Test_TM_SDLP_AddIdlePacket_Overflow(void)
{
    ...
    CFE_MSG_Init((CFE_MSG_Message_t *) dataPacket, 0x0801, 90, true);
    actual = TM_SDLP_AddPacket(&frameInfo, (CFE_MSG_Message_t *) dataPacket);
    expected = 4;
    UtAssert_True(actual == expected, "properly initialized");
...
void Test_TM_SDLP_AddVcaData_TooLarge(void)
{
    ...
    CFE_MSG_Init((CFE_MSG_Message_t *) dataPacket, 0x0801, 200, true);
...
void Test_TM_SDLP_SetOidFrame_NotEmpty(void)
{
    ...
    CFE_MSG_Init((CFE_MSG_Message_t *) dataPacket, 0x0801, 10, true);
    actual = TM_SDLP_AddPacket(&frameInfo, (CFE_MSG_Message_t *) dataPacket);
...
void Test_TM_SDLP_NominalTest(void)
{
    ...
    CFE_MSG_Init((CFE_MSG_Message_t *) dataPacket, 0x0801, 40, true);
    actual = TM_SDLP_AddPacket(&frameInfo, (CFE_MSG_Message_t *) dataPacket);
    expected = 0; 
    ...
    /* Add small packet */
    CFE_MSG_Init((CFE_MSG_Message_t *) dataPacket, 0x0801, 26, true);
    actual = TM_SDLP_AddPacket(&frameInfo, (CFE_MSG_Message_t *) dataPacket);
    expected = 4; 
    ...
    CFE_MSG_Init((CFE_MSG_Message_t *) dataPacket, 0x0801, 80, true);
    actual = TM_SDLP_AddPacket(&frameInfo, (CFE_MSG_Message_t *) dataPacket);
    expected = 0; 
    UtAssert_True(actual == expected, "Add large packet");
    expected = 30;
    ...
    CFE_MSG_Init((CFE_MSG_Message_t *) dataPacket, 0x0801, 28, true);
    actual = TM_SDLP_AddPacket(&frameInfo, (CFE_MSG_Message_t *) dataPacket);
    
    CFE_MSG_Init((CFE_MSG_Message_t *) dataPacket, 0x0801, 6, true);
    uint8 ii = 0;
    for (ii = 0; ii < 13; ++ii)
    {
        actual = TM_SDLP_AddPacket(&frameInfo, (CFE_MSG_Message_t *) dataPacket);

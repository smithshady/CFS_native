...
void                Ut_CFE_MSG_SetMsgIdHook(CFE_SB_Buffer_t MsgPtr,CFE_SB_MsgId_t MsgId);
...
int32               Ut_CFE_MSG_SetMsgTimeHook(CFE_SB_Buffer_t MsgPtr,CFE_TIME_SysTime_t Time);
void                Ut_CFE_SB_TimeStampMsgHook(CFE_SB_Buffer_t MsgPtr);
uint16              Ut_CFE_MSG_GetFcnCodeHook(CFE_SB_Buffer_t MsgPtr);
int32               Ut_CFE_MSG_SetFcnCodeHook(CFE_SB_Buffer_t MsgPtr,uint16 CmdCode);

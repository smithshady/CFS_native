...
typedef struct
{
    ...
    int32 (*CFE_MSG_GetMsgId)(CFE_SB_Buffer_t MsgPtr);
    int32 (*CFE_MSG_SetMsgId)(CFE_SB_Buffer_t MsgPtr,CFE_SB_MsgId_t MsgId);
    int32 (*CFE_SB_GetUserDataLength)(CFE_SB_Buffer_t MsgPtr);
    int32 (*CFE_SB_SetUserDataLength)(CFE_SB_Buffer_t MsgPtr,uint16 DataLength);
    int32 (*CFE_MSG_GetSizeA)(CFE_SB_Buffer_t MsgPtr);
    int32 (*CFE_MSG_SetSize)(CFE_SB_Buffer_t MsgPtr,uint16 TotalLength);
    ...
    int32 (*CFE_SB_TimeStampMsg)(CFE_SB_Buffer_t MsgPtr);
    int32 (*CFE_MSG_GetFcnCode)(CFE_SB_Buffer_t MsgPtr);
    int32 (*CFE_MSG_SetFcnCode)(CFE_SB_Buffer_t MsgPtr,uint16 CmdCode);
    int32 (*CFE_SB_GetChecksum)(CFE_SB_Buffer_t MsgPtr);
    int32 (*CFE_MSG_GenerateChecksum)(CFE_SB_Buffer_t MsgPtr);
    int32 (*CFE_MSG_ValidateChecksum)(CFE_SB_Buffer_t MsgPtr);

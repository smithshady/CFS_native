...
uint32 Ut_CFE_SB_GetMsgCount(uint16 MessageID)
{
    ...
    while (CurrentNode) {
        ...
        if (MessageID == CFE_MSG_GetMsgId(MessagePtr)) {
            MessageCount++;
        }
...
{
    UtList_Add(&MsgQueue, MsgPtr, CFE_MSG_GetSizeA(MsgPtr), 0);

    UtPrintf("PKT: ");
    UtPrintx(MsgPtr, (uint16)(CFE_MSG_GetSizeA(MsgPtr)));
    return CFE_SUCCESS;
}
...
void Ut_CFE_SB_AddMsgToPipe(void *MsgPtr, CFE_SB_PipeId_t PipeId)
{
    if (PipeTable[PipeId].InUse == true) {
        UtList_Add(&PipeTable[PipeId].MsgQueue, MsgPtr, CFE_MSG_GetSizeA((CFE_SB_Buffer_t)MsgPtr), 0);
    }
    else {
...
int32 Ut_CFE_SB_ReceiveBufferHook(CFE_SB_Buffer_t *BufPtr, CFE_SB_PipeId_t PipeId, int32 TimeOut)
{
    UtListNode_t        *CurrentNode;
...
void *Ut_CFE_SB_GetUserDataHook(CFE_SB_Buffer_t MsgPtr)
{
#ifdef MESSAGE_FORMAT_IS_CCSDS
    uint8           *BytePtr;
...
CFE_SB_MsgId_t Ut_CFE_MSG_GetMsgIdHook(CFE_SB_Buffer_t MsgPtr)
{
#ifdef MESSAGE_FORMAT_IS_CCSDS
...
#endif
}/* end Ut_CFE_MSG_GetMsgIdHook */

void Ut_CFE_MSG_SetMsgIdHook(CFE_SB_Buffer_t MsgPtr,
                     CFE_SB_MsgId_t MsgId)
{
#ifdef MESSAGE_FORMAT_IS_CCSDS
...
uint16 Ut_CFE_SB_GetUserDataLengthHook(CFE_SB_Buffer_t MsgPtr)
{
#ifdef MESSAGE_FORMAT_IS_CCSDS
    uint16 TotalMsgSize;
    uint16 HdrSize;
    ...
    TotalMsgSize = CFE_MSG_GetSizeA(MsgPtr);
    HdrSize = CFE_SB_MsgHdrSize(MsgId);
...
void Ut_CFE_SB_SetUserDataLengthHook(CFE_SB_Buffer_t MsgPtr,uint16 DataLength)
{
#ifdef MESSAGE_FORMAT_IS_CCSDS
...
uint16 Ut_CFE_MSG_GetSizeAHook(CFE_SB_Buffer_t MsgPtr)
{
#ifdef MESSAGE_FORMAT_IS_CCSDS
...
#endif
}/* end Ut_CFE_MSG_GetSizeAHook */

void Ut_CFE_MSG_SetSizeHook(CFE_SB_Buffer_t MsgPtr,uint16 TotalLength)
{
#ifdef MESSAGE_FORMAT_IS_CCSDS
...
#endif
}/* end Ut_CFE_MSG_SetSizeHook */

CFE_TIME_SysTime_t Ut_CFE_MSG_GetMsgTimeHook(CFE_SB_Buffer_t MsgPtr)
{
#ifdef MESSAGE_FORMAT_IS_CCSDS
...
#endif
}/* end Ut_CFE_MSG_GetMsgTimeHook */

int32 Ut_CFE_MSG_SetMsgTimeHook(CFE_SB_Buffer_t MsgPtr,
...
//void Ut_CFE_SB_TimeStampMsgHook(CFE_SB_Buffer_t MsgPtr)
//{
//    CFE_MSG_SetMsgTime(MsgPtr,CFE_TIME_GetTime());
//
//}/* end Ut_CFE_SB_TimeStampMsgHook */

uint16 Ut_CFE_MSG_GetFcnCodeHook(CFE_SB_Buffer_t MsgPtr)
{
#ifdef MESSAGE_FORMAT_IS_CCSDS
...
#endif
}/* end Ut_CFE_MSG_GetFcnCodeHook */

int32 Ut_CFE_MSG_SetFcnCodeHook(CFE_SB_Buffer_t MsgPtr,
                      uint16 CmdCode)
{
#ifdef MESSAGE_FORMAT_IS_CCSDS
...
}/* end Ut_CFE_MSG_SetFcnCodeHook */

uint16 Ut_CFE_SB_GetChecksumHook(CFE_SB_Buffer_t MsgPtr)
{
#ifdef MESSAGE_FORMAT_IS_CCSDS
...
void Ut_CFE_MSG_GenerateChecksumHook(CFE_SB_Buffer_t MsgPtr)
{
#ifdef MESSAGE_FORMAT_IS_CCSDS
...
#endif
}/* end Ut_CFE_MSG_GenerateChecksumHook */

bool Ut_CFE_MSG_ValidateChecksumHook(CFE_SB_Buffer_t MsgPtr)
{
#ifdef MESSAGE_FORMAT_IS_CCSDS
...
#endif
}/* end Ut_CFE_MSG_ValidateChecksumHook */

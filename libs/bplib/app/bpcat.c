...
static void parse_ip_address(char *buffer, size_t buf_size, OS_SockAddr_t *parsed_addr, in_addr_t dfl_host,
                             in_port_t dfl_port)
{
    char *host_start;
    char *port_start;
...
static int setup_cla(bplib_routetbl_t *rtbl, const OS_SockAddr_t *local_cla_addr,
                     const OS_SockAddr_t *remote_cla_addr)
{
...
int main(int argc, char *argv[])
{
    ...
    OS_SockAddr_t local_cla_addr;
    OS_SockAddr_t remote_cla_addr;
    uint64_t           stats_time;
    uint64_t           curr_time;

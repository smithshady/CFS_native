...
/*                                                                 */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
bool CFS_IsValidFilename(char   *Filename, 
                            uint32 Length)
{
   bool Valid = true;
   int32   i;
...
/*                                                                 */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */   
bool CFS_ResolveSymAddr(CFS_SymAddr_t *SymAddr, 
                           uint32        *ResolvedAddr)
{
    bool   Valid;   
    int32     OS_Status = OS_SUCCESS;
...
/*                                                                 */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */   
bool CFS_Verify32Aligned(uint32 Address, 
                            uint32 Size)
{
   bool IsAligned;
...
/*                                                                 */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */   
bool CFS_Verify16Aligned(uint32 Address, 
                            uint32 Size)
{
   bool IsAligned;
...
/*                                                                 */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */   
bool CFS_IsPacketFiltered(CFE_SB_Buffer_t* MessagePtr,
                             uint16          FilterType,
                             uint16          Algorithm_N,
                             uint16          Algorithm_X,
                             uint16          Algorithm_O)
    ...
    */ 
    ...
    else
    {
        if (FilterType == CFS_PKT_SEQUENCE_BASED_FILTER_TYPE)
        {
            ...
            */ 
            PacketValue = CCSDS_RD_SEQ(MessagePtr->Msg);
        }
        else
        {
            /* 
            ...
            */ 
            CFE_MSG_GetMsgTime(&(MessagePtr->Msg), &PacketTime);  
...
bool CFS_VerifyString(char *Buffer, int32 BufferSize,
                         bool StringIsRequired, bool NeedCharTest)
{

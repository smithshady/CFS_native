...
uint16 HS_APP_TEST_CFE_SB_ReceiveBufferHookCount;
...
int32 HS_APP_TEST_CFE_SB_ReceiveBufferHook(void *UserObj, int32 StubRetcode, uint32 CallCount, const UT_StubContext_t *Context)
{
    HS_APP_TEST_CFE_SB_ReceiveBufferHookCount++;

    if (HS_APP_TEST_CFE_SB_ReceiveBufferHookCount % 2 == 1)
        return CFE_SUCCESS;
    else
...
void HS_ProcessCommands_Test(void)
{
    ...
    /* Causes CFE_SB_ReceiveBuffer to alternate returning CFE_SUCCESS and CFE_SB_NO_MESSAGE, to reach all code branches. */
    HS_APP_TEST_CFE_SB_ReceiveBufferHookCount = 0;
    ...
    UT_SetDeferredRetcode(UT_KEY(CFE_SB_ReceiveBuffer), 2, CFE_SB_NO_MESSAGE);
    /* UT_SetHookFunction(UT_KEY(CFE_SB_ReceiveBuffer), HS_APP_TEST_CFE_SB_ReceiveBufferHook, NULL); */

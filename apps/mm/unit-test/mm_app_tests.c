...
CFE_Status_t MM_APP_TEST_CFE_SB_ReceiveBufferHook(void *UserObj, int32 StubRetcode, uint32 CallCount,
...
void MM_AppMain_Test_Nominal(void)
{
    ...
    /* Set to prevent call to CFE_SB_ReceiveBuffer from returning an error */
    UT_SetHookFunction(UT_KEY(CFE_SB_ReceiveBuffer), MM_APP_TEST_CFE_SB_ReceiveBufferHook, NULL);

...
#endif
#ifdef HAVE_ATSAM_TEST
                                      {CFE_SB_MSGID_WRAP_VALUE(ATSAM_TEST_HK_TLM_MID), {0, 0}, 4},
#endif
#ifdef HAVE_CF
                                      {CFE_SB_MSGID_WRAP_VALUE(CF_CHANNEL_0_OUTPUT_MID), {0, 0}, 512},
                                      {CFE_SB_MSGID_WRAP_VALUE(CF_EOT_TLM_MID), {0, 0}, 512},
#endif

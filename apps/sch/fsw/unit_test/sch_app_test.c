...
int32 SCH_APP_TEST_CFE_SB_ReceiveBufferHook(CFE_SB_Buffer_t *BufPtr, CFE_SB_PipeId_t PipeId, int32 TimeOut)
{
...
void SCH_SbInit_Test_CreatePipeError(void)
{
    ...
    SCH_AppData.MsgPtr  = (CFE_SB_Buffer_t) 1;
    ...
    /* Verify results */
    UtAssert_True (SCH_AppData.MsgPtr  == (CFE_SB_Buffer_t) 0, "SCH_AppData.MsgPtr  == (CFE_SB_Buffer_t) 0");
...
void SCH_TblInit_Test_LoadSdtError(void)
{
    ...
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_SDT_LOAD_ERR_EID, CFE_EVS_EventType_ERROR, "Error (RC=0xFFFFFFFF) Loading SDT with /cf/apps/sch_def_schtbl.tbl"),
...
void SCH_TblInit_Test_LoadMdtError(void)
{
    ...
    UtAssert_True
        (Ut_CFE_EVS_EventSent(SCH_MDT_LOAD_ERR_EID, CFE_EVS_EventType_ERROR, "Error (RC=0xCC000013) Loading MDT with /cf/apps/sch_def_msgtbl.tbl"),
...
void SCH_ProcessCommands_Test_OneMessage(void)
{
    ...
    SCH_AppData.MsgPtr  = (CFE_SB_Buffer_t)(&CmdPacket);

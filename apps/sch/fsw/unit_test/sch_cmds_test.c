...
void SCH_AppPipe_Test_SendHK(void)
{
    ...
    Result = SCH_AppPipe((CFE_SB_Buffer_t)(&CmdPacket));
...
void SCH_AppPipe_Test_Noop(void)
{
    ...
    CFE_MSG_SetFcnCode ((CFE_SB_Buffer_t)(&CmdPacket), SCH_NOOP_CC);
...
void SCH_AppPipe_Test_Reset(void)
{
    ...
    CFE_MSG_Init (&CmdPacket, SCH_CMD_MID, sizeof(SCH_NoArgsCmd_t), true);
    CFE_MSG_SetFcnCode ((CFE_SB_Buffer_t)(&CmdPacket), SCH_RESET_CC);
...
void SCH_AppPipe_Test_Enable(void)
{
    ...
    CFE_MSG_SetFcnCode ((CFE_SB_Buffer_t)(&CmdPacket), SCH_ENABLE_CC);
...
void SCH_AppPipe_Test_Disable(void)
{
    ...
    CFE_MSG_Init (&CmdPacket, SCH_CMD_MID, sizeof(SCH_EntryCmd_t), true);
    CFE_MSG_SetFcnCode ((CFE_SB_Buffer_t)(&CmdPacket), SCH_DISABLE_CC);
...
void SCH_AppPipe_Test_EnableGroupCmd(void)
{
    ...
    CFE_MSG_SetFcnCode ((CFE_SB_Buffer_t)(&CmdPacket), SCH_ENABLE_GROUP_CC);
...
void SCH_AppPipe_Test_DisableGroupCmd(void)
{
    ...
    CFE_MSG_Init (&CmdPacket, SCH_CMD_MID, sizeof(SCH_GroupCmd_t), true);
    CFE_MSG_SetFcnCode ((CFE_SB_Buffer_t)(&CmdPacket), SCH_DISABLE_GROUP_CC);
...
void SCH_AppPipe_Test_EnableSyncCmd(void)
{
    ...
    CFE_MSG_Init (&CmdPacket, SCH_CMD_MID, sizeof(SCH_NoArgsCmd_t), true);
    CFE_MSG_SetFcnCode ((CFE_SB_Buffer_t)(&CmdPacket), SCH_ENABLE_SYNC_CC);
...
void SCH_AppPipe_Test_SendDiagTlmCmd(void)
{
    ...
    CFE_MSG_SetFcnCode ((CFE_SB_Buffer_t)(&CmdPacket), SCH_SEND_DIAG_TLM_CC);
...
void SCH_AppPipe_Test_InvalidCommandCode(void)
{
    ...
    CFE_MSG_Init (&CmdPacket, SCH_CMD_MID, sizeof(SCH_NoArgsCmd_t), true);
    CFE_MSG_SetFcnCode ((CFE_SB_Buffer_t)(&CmdPacket), 99);
...
void SCH_HousekeepingCmd_Test(void)
{
    ...
    /* Execute the function being tested */
    Result = SCH_HousekeepingCmd((CFE_SB_Buffer_t)(&CmdPacket));
...
void SCH_NoopCmd_Test_Error(void)
{
    ...
    /* Execute the function being tested */
    SCH_NoopCmd((CFE_SB_Buffer_t)(&CmdPacket));
...
void SCH_ResetCmd_Test_Error(void)
{
    ...
    /* Execute the function being tested */
    SCH_ResetCmd((CFE_SB_Buffer_t)(&CmdPacket));
...
void SCH_EnableCmd_Test_InvalidCmdLength(void)
{
    ...
    /* Execute the function being tested */
    SCH_EnableCmd((CFE_SB_Buffer_t)(&CmdPacket));
...
void SCH_DisableCmd_Test_InvalidCmdLength(void)
{
    ...
    /* Execute the function being tested */
    SCH_DisableCmd((CFE_SB_Buffer_t)(&CmdPacket));
...
void SCH_EnableGroupCmd_Test_InvalidCmdLength(void)
{
    ...
    /* Execute the function being tested */
    SCH_EnableGroupCmd((CFE_SB_Buffer_t)(&CmdPacket));
...
void SCH_DisableGroupCmd_Test_InvalidCmdLength(void)
{
    ...
    /* Execute the function being tested */
    SCH_DisableGroupCmd((CFE_SB_Buffer_t)(&CmdPacket));
...
void SCH_EnableSyncCmd_Test_InvalidCmdLength(void)
{
    ...
    /* Execute the function being tested */
    SCH_EnableSyncCmd((CFE_SB_Buffer_t)(&CmdPacket));
...
void SCH_SendDiagTlmCmd_Test_InvalidCmdLength(void)
{
    ...
    /* Execute the function being tested */
    SCH_SendDiagTlmCmd((CFE_SB_Buffer_t)(&CmdPacket));
...
void SCH_VerifyCmdLength_Test_LengthError(void)
{
    ...
    CFE_MSG_Init (&CmdPacket, SCH_CMD_MID, sizeof(SCH_NoArgsCmd_t), true);
    CFE_MSG_SetFcnCode ((CFE_SB_Buffer_t)(&CmdPacket), 1);

    /* Execute the function being tested */
    Result = SCH_VerifyCmdLength((CFE_SB_Buffer_t)(&CmdPacket), 99);
...
void SCH_VerifyCmdLength_Test_Success(void)
{
    ...
    /* Execute the function being tested */
    Result = SCH_VerifyCmdLength((CFE_SB_Buffer_t)(&CmdPacket), sizeof(SCH_NoArgsCmd_t));

...
extern void TO_SendDataTypePktCmd(CFE_SB_Buffer_t);
...
int32 TO_CustomAppCmds(CFE_SB_Buffer_t pCmdMsg)
{
    uint32 uiCmdCode = CFE_MSG_GetFcnCode(pCmdMsg);
...
int32   TO_CustomProcessData(CFE_SB_Buffer_t pTlmMsg, int32 size, int32 tblIdx,
                             uint16 usRouteId)
{
...
int32 TO_CustomEnableOutputCmd(CFE_SB_Buffer_t pCmdMsg)
{

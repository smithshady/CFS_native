...
*******************************************************************************/
void TO_NoopCmd(CFE_SB_Buffer_t*);
...
*   \param[in] pCmdMsg Cmd of type TO_NoArgCmd_t
*******************************************************************************/
void TO_ResetCmd(CFE_SB_Buffer_t*);
...
*******************************************************************************/
void TO_EnableOutputCmd(CFE_SB_Buffer_t*);
...
*******************************************************************************/
void TO_DisableOutputCmd(CFE_SB_Buffer_t*);
...
*******************************************************************************/
void TO_ActivateRoutesCmd(CFE_SB_Buffer_t*);
...
*   \param[in] pCmdMsg Cmd of type TO_RouteMaskArgCmd_t
*******************************************************************************/
void TO_DeactivateRoutesCmd(CFE_SB_Buffer_t*);
...
*   \param[in] pCmdMsg Cmd of type TO_NoArgCmd_t
*******************************************************************************/
void TO_PauseOutputCmd(CFE_SB_Buffer_t*);
...
*   \param[in] pCmdMsg Cmd of type TO_NoArgCmd_t
*******************************************************************************/
void TO_ResumeOutputCmd(CFE_SB_Buffer_t*);
...
*******************************************************************************/
void TO_AddTblEntryCmd(CFE_SB_Buffer_t*);
...
*******************************************************************************/
void TO_RemoveTblEntryCmd(CFE_SB_Buffer_t*);
...
*   \param[in] pCmdMsg Cmd of type TO_MidArgCmd_t
*******************************************************************************/
void TO_EnableTblEntryCmd(CFE_SB_Buffer_t*);
...
*   \param[in] pCmdMsg Cmd of type TO_MidArgCmd_t
*******************************************************************************/
void TO_DisableTblEntryCmd(CFE_SB_Buffer_t*);
...
*******************************************************************************/
void TO_EnableGroupCmd(CFE_SB_Buffer_t*);
...
*   \param[in] pCmdMsg Cmd of type TO_GroupArgCmd_t
*******************************************************************************/
void TO_DisableGroupCmd(CFE_SB_Buffer_t*);
...
*   \param[in] pCmdMsg Cmd of type TO_NoArgCmd_t
*******************************************************************************/
void TO_EnableAllCmd(CFE_SB_Buffer_t*);
...
*   \param[in] pCmdMsg Cmd of type TO_NoArgCmd_t
*******************************************************************************/
void TO_DisableAllCmd(CFE_SB_Buffer_t*);
...
*******************************************************************************/
void TO_SetRouteByMidCmd(CFE_SB_Buffer_t*);
...
*******************************************************************************/
void TO_SetRouteByGroupCmd(CFE_SB_Buffer_t*);
...
*******************************************************************************/
void TO_ManageTableCmd(CFE_SB_Buffer_t*);
...
*******************************************************************************/
void TO_SetRoutePeriodCmd(CFE_SB_Buffer_t*);
...
*******************************************************************************/
void TO_SetWakeupTimeoutCmd(CFE_SB_Buffer_t*);
